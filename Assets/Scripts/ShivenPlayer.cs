...
public class ShivenPlayer : MonoBehaviour
{
    ...
    void SetAnimation()
    {
        ...
        if (!isGrounded)
        {
            if (rb.linearVelocity.y > 0.1f)
                ChangeAnimation("ShivenPlayer_Jump");
            else
                ChangeAnimation("ShivenPlayer_Fall");
            return;
        }
        ...
        if (xSpeed < 0.1f)
            ChangeAnimation("ShivenPlayer_Idle");
        else if (isRunning)
            ChangeAnimation("ShivenPlayer_Run");
        else
            ChangeAnimation("ShivenPlayer_Walking");
    }
